...
export default function Section() {
  ...
  return (
    <div>
      <div className="bg-[url('/images/6.jpg')] bg-cover bg-no-repeat bg-center h-[50vh] md:h-[80vh] lg:h-[100vh] mt-20  flex flex-col justify-center items-center md:items-start  border-[2px] border-b-black ">
