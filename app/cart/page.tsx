                ...
                <div key={item.id} className=" grid gap-5">
                  <div className="border items-center   p-4 rounded flex justify-center  gap-10">
                    ...
                    <div className=" flex flex-col gap-3">
                      ...
                      <div>
                        <div className="flex ">
                          <button onClick={() => increaseQuantity(item.id)} className="border-black border-[1px] w-6 h-5 flex items-center justify-center bg-blue-950 text-white  hover:bg-darkBlue  hover:text-dullWhite"> + </button>
                          <p className="border-[1px] border-black w-5 h-5 flex justify-center  items-center italic ">
                            {item.quantity}
                          </p>
                          <button onClick={() => decreaseQuantity(item.id)} className="border-black border-[1px] w-6 h-5 flex items-center justify-center  bg-red-600  hover:bg-red-700  text-dullWhite font-bold "> - </button>
                        </div>
